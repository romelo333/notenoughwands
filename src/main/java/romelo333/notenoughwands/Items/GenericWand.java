...
public class GenericWand extends Item {
    ...
    protected static void error(EntityPlayer player, String msg) {
        player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.RED + msg));
    }

    protected static void notify(EntityPlayer player, String msg) {
    ...
    protected static String getBlockName(Block block, int meta) {
